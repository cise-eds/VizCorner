...
\begin{abstract}
We provide a retrospective of the Visualization Corner and how its articles covered visualization topics since 2011. This leads us to identify current and future developments in visualization research and their impact on computing in science and engineering.
\end{abstract}
}
...
With multidimensional and multivariate visualization, flow visualization, and human-computer interaction, we have already touched some relevant visualization themes that build a versatile foundation for many applications. However, the VizCorner is not restricted to just these themes. Previous papers covered approaches to direct analytical support in visualization, advanced volume rendering, efficient parallel processing, mathematical modeling, or incorporating text in visualization.  %---showing the breadth in visualization methods relevant for science and engineering. 
